/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d629ed63976c5535c4aceb349d06cc6f)
...
declare namespace Cloudflare {
  ...
  interface Env {
    NOTIFICATION_EMAIL_ADDRESS: 'user@example.com';
    DB: D1Database;
    AES_ENCRYPTION_KEY_SECRET: SecretsStoreSecret;
    MAIL_MEOW_API_SECRET: SecretsStoreSecret;
    SELF: Service<typeof import('./src/index').default>;
    TOTP_GENERATOR: Fetcher /* totp-generator */;
    MAIL_MEOW: Fetcher /* mail-meow */;
    BROWSER: Fetcher;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'NOTIFICATION_EMAIL_ADDRESS'>> {}
}
